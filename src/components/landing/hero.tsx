      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-24">
          ...
          <div className="relative z-20 text-right lg:w-1/2">
            <div className="reveal group mb-8 inline-flex cursor-default items-center gap-2 rounded-full border border-white/40 bg-white/60 px-4 py-2   backdrop-blur-md transition-all hover:shadow-md">
              <span className="relative flex h-2.5 w-2.5">
                ...
                <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-primary transition-colors group-hover:bg-indigo-600"></span>
              </span>
              <span className="text-xs font-bold tracking-wide text-slate-700 transition-colors group-hover:text-primary">
                مفهوم جديد للاستثمار العقاري
              </span>
            </div>

            <h1 className="reveal delay-100 mb-8 text-balance text-5xl font-black leading-[1.15] tracking-tighter text-slate-900 drop-  sm:text-6xl md:text-7xl md:leading-[1.1] lg:text-8xl">
              استثمر بذكاء، <br />
            ...
            <p className="reveal delay-200 mb-10 max-w-xl text-balance text-lg font-normal leading-relaxed text-slate-600 md:text-xl">
            ...
            <div className="reveal delay-300 mb-16 flex w-full flex-col items-center gap-4 sm:w-auto sm:flex-row">
              <button
                ...
                className="group relative w-full overflow-hidden rounded-2xl bg-slate-900 px-10 py-5 text-base font-bold text-white shadow-2xl shadow-slate-900/30 ring-4 ring-transparent transition-all duration-300 hover:-translate-y-1 hover:bg-slate-800 hover:ring-slate-900/10 active:scale-95 sm:w-auto"
              >
              ...
              <button
                ...
                className="w-full rounded-2xl border border-slate-200 bg-white/60 px-10 py-5 text-base font-bold text-slate-700 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-white hover:text-primary hover:shadow-lg active:scale-95 sm:w-auto"
              >
                <span>حجز إقامة</span>
              </button>
            </div>

            <div className="reveal delay-500 grid max-w-lg grid-cols-3 gap-6 border-t border-slate-200/60 pt-8">
              <div className="hover-target group cursor-default">
                <p className="text-3xl font-black tracking-tight text-slate-900 transition-colors duration-300 group-hover:text-primary">
                  +250
                </p>
                <p className="mt-1 text-xs font-bold text-slate-500 group-hover:text-slate-700">وحدة سكنية</p>
              </div>
              <div className="hover-target group cursor-default">
                <p className="text-3xl font-black tracking-tight text-slate-900 transition-colors duration-300 group-hover:text-primary">
                  98%
                </p>
                <p className="mt-1 text-xs font-bold text-slate-500 group-hover:text-slate-700">رضا العملاء</p>
              </div>
              <div className="hover-target group cursor-default">
                <p className="text-3xl font-black tracking-tight text-slate-900 transition-colors duration-300 group-hover:text-primary">
                  24/7
                </p>
                <p className="mt-1 text-xs font-bold text-slate-500 group-hover:text-slate-700">دعم متواصل</p>
              </div>
            </div>
          </div>
          ...
          >
            <div
              ref={imageRef}
              className="group relative z-10 h-[450px] w-full overflow-hidden rounded-[2.5rem] border-[8px] border-white/80 bg-slate-100 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)] transition-transform duration-200 ease-out md:h-[650px]"
              style={{
              ...
              >
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex -space-x-3 space-x-reverse">
                    ...
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border-[3px] border-white bg-slate-900 text-[10px] font-bold text-white  ">
                      +2k
                    </div>
                  </div>
            ...
            <div className="absolute -right-8 top-[40%] z-20 hidden cursor-pointer rounded-3xl border border-white/50 bg-white/95 p-6 shadow-xl backdrop-blur-xl transition-transform duration-300 hover:scale-105 md:-right-14 md:block">
              <div className="flex items-center gap-5">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-green-50 to-emerald-100/50 text-3xl text-emerald-600 shadow-inner">
                  📈
                </div>
                <div>
                  <p className="mb-1 text-[11px] font-bold uppercase tracking-wider text-slate-400">متوسط العائد السنوي</p>
