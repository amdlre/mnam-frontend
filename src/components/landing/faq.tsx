    ...
    <div className="bg-muted/30 py-16 md:py-24" id="faq">
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mb-10 text-center md:mb-16">
          ...
          <h2 className="mb-3 text-2xl font-bold text-foreground md:mb-4 md:text-3xl lg:text-4xl">{t('title')}</h2>
        ...
        <div className="grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-2">
          ...
          <div>
            <div className="mb-8 flex items-center gap-3 border-b border-border pb-4">
              ...
              <h3 className="text-2xl font-bold text-foreground">{t('guestTitle')}</h3>
            </div>
          ...
          <div>
            <div className="mb-8 flex items-center gap-3 border-b border-border pb-4">
              <span className="text-2xl">🏢</span>
              <h3 className="text-2xl font-bold text-foreground">{t('ownerTitle')}</h3>
            </div>
            <div className="space-y-4">
        ...
        <div className="mt-16 text-center">
          <p className="mb-4 text-muted-foreground">{t('noAnswer')}</p>
          <button
